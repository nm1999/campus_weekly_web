...
<body>
   <nav class="navbar">
        <div class="container-fluid align-items-center">
            <h6 >                               
                <a class="index" style="color: rgb(166, 166, 202); text-decoration: none;">CampusWeekly</a>        
            </h6>
            <div>
                <ul>
                    <li><a href="admin/login.php" >Login</a></li>
                    <li><a href="admin/register.php">SignUp</a></li>
                </ul>
            </div>
        </div>
    </nav>
    <div class="pages">
        ...
        <!-- <div class="loginpage">
            <?php include 'admin/loginInterface.php'?>
        </div>
        <div class="registerpage">
            <?php include 'admin/registerInterface.php'?>
        </div> -->
    </div>
