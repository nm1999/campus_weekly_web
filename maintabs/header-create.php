                ...
                <div class="row">
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 sidebar fixed-top">
                        ...
                        <ul class="navbar-nav flex-column mt-4" >
                            <li class="nav-item"><a href="dashboardinterface?raw-data=<?php echo $_GET['raw-data']?>" class="nav-link text-white p-3 mb-2 "><i class="fa fa-home text-light fa-lg mr-3"></i>Feed</a></li>
                            ...
                            <li class="nav-item"><a href="create?raw-data=<?php echo $_GET['raw-data']?>" class="nav-link text-white p-3 mb-2 sidebar-link current"><i class="fa fa-edit text-light fa-lg mr-3"></i>Create</a></li>
    ...
    <div class="nav-2" >
        <ul class="nav-links" style="z-index: 1000;">
            <div style="justify-content: left;">
                <li class="nav-item"></li><a href="dashboardinterface" class="nav-link text-white p-3 mb-2 current"><i class="fa fa-home text-light fa-lg mr-3"></i>Feed</a></li>
